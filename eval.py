...
def eval_model(modelname, data_type, device="cpu", save_plots=False, size=256, show_training_data=True, model=None, train_embed=None, head_layer=8, density=GaussianDensitySklearn(),mode = 'valid'):
    # create test dataset
    ...
    if train_embed is None:
        train_embed = get_train_embeds(model, size, data_type, test_transform, device)
